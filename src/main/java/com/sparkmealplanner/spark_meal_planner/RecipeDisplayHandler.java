...
import spark.Route;
/**
 * The following class handles the HMTL and java elements of the recipe full display of the app
 *
 */
public class RecipeDisplayHandler implements Route {
	...
	/**
	 * The following handler method returns the HTML elements of the display full recipe page of the app
	 */
	...
	/**
	 * The following method returns the HTML elements for the send to calendar button
	 * @return HTML
	 */
	...
	/**
	 * 	The following method returns the Dish object in a static manner, so another page can obtain it
	 * @return the dish
	 */
	...
	/**
	 * The following method returns the HTML elements necessary to get and display the full recipe
	 * from Yummly API
	 *  
	 * @return HTML
	 */
